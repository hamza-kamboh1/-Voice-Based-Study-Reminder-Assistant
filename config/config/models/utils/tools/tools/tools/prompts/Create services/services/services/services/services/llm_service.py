    ...
    def generate_response(self, 
        ...
        try:
            ...
            if message.get("tool_calls"):
                ...
                logger.info(f"LLM generated: {message.get('content', '')[:50]}...")
            
            return message
            
        except openai.error.AuthenticationError:
            logger.error("OpenAI authentication failed. Check your API key.")
            return {"content": "I'm having trouble with my authentication. Please check my configuration."}
        except openai.error.RateLimitError:
            logger.error("OpenAI rate limit exceeded")
            return {"content": "I'm getting too many requests. Please wait a moment."}
